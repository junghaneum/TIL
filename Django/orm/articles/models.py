...
class Article(models.Model):
    ...
    created_at = models.DateTimeField(auto_now_add=True) # 생성 될 때만 저장
    updated_at = models.DateTimeField(auto_now=True) # 데이터가 변경 될 때마다 저장
    ...
    # 2-5. order_by()
    # articles = Article.objects.order_by('created_at') # 오름차순
    # articles = Article.objects.order_by('-created_at') # 내림차순
